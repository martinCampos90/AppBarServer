...
import bulebar.reservacion.appbarserver.Common.DirectionJSONParser;
    ...
    private void displayLocation() {
                ...
                && ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED)
        {
            ...
            if(mLastLocation != null){
                ...
                //Toast.makeText(this,"No pudo obtenerse la ubicación",Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    private boolean checkPlayServices() {
        ...
        if(resultCode != ConnectionResult.SUCCESS){
            if(GooglePlayServicesUtil.isUserRecoverableError(resultCode)){
                ...
                Toast.makeText(this,"Este dispositivo no soporta",Toast.LENGTH_SHORT).show();
                finish();
            }
            return false;
